...
export default function Home() {
  return (
    <>
      ...
      {/* MORE LINKS */}
      <section style={{ padding: "80px 5%", background: "var(--bg-soft)" }}>
        <div style={{ maxWidth: 1000, margin: "0 auto" }}>
          <Reveal style={{ textAlign: "center", marginBottom: 40 }}>
            <p style={{ color: "#C9A84C", fontSize: "0.75rem", letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: 12 }}>Want to Know More?</p>
            <h2 style={{ fontFamily: "Playfair Display, serif", fontSize: "clamp(1.6rem, 3vw, 2.2rem)", fontWeight: 700, color: "var(--text)" }}>Learn More About <span className="gold-gradient">Picture It</span></h2>
          </Reveal>
          <Reveal delay={100} style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap" }}>
